<h1><?= getUserFullName($user); ?>'s Profile</h1>
<hr class="my-5" />
...
<div class="row">
  ...
  <div class="col-12 col-md-6 col-lg-9">
    ...
    <!-- REVIEWS RECEIVED -->
    <section class="mb-5">
      <h2 class="section__heading">Reviews for <?= getUserFullName($user); ?></h2>
      <hr class="section__rule my-3" />
    ...
    <!-- REVIEWS GIVEN -->
    <section class="mb-5">
      <h2 class="section__heading">Reviews by <?= getUserFullName($user); ?></h2>
      <hr class="section__rule my-3" />
