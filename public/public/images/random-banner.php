...
/*
	random-banner.php
	-----------------
	This script checks a directory for jpeg files 
	and picks one of them at random and then 
	loads the file. 
	
	To use this script, place the relative/absolute 
	to this file inside the src attribute of the 
	image tag.
*/
...
foreach (new DirectoryIterator(__DIR__ . '/banners/') as $file) {
	...
	*/
	if (!strpos($file->getFileName(), '.jpg')) continue;
